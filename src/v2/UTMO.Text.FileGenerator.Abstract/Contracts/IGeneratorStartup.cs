...
// // ***********************************************************************
// // <copyright file="IGeneratorStartup.cs" company="Joshua S. Irwin">
...
namespace UTMO.Text.FileGenerator.Abstract.Contracts
{
    public interface IGeneratorStartup
    {
        ...
        Task ConfigureEnvironment(ITemplateGenerationEnvironment environment);
        
        /// <summary>
        /// Configures the environment plugins.
        /// </summary>
        /// <param name="pluginManager">The environment plugin manager.</param>
        Task ConfigurePlugins(IRegisterPluginManager pluginManager);
    }
}