...
{
    public static dynamic CombineManifests(this object object1, object object2)
    {
    ...
    private static IDictionary<string, object> GetKeyValueMap(object? values)
    {
        ...
        {
            map.Add(descriptor.Name, descriptor.GetValue(values) ?? throw new InvalidOperationException());
        }
